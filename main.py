...
def main():
    ...
    while running:
        ...
        slider1.set_current_digit(math.floor(hour / 10))
        slider2.set_current_digit(hour % 10)
        slider3.set_current_digit(math.floor(minute / 10))
        slider4.set_current_digit(minute % 10)
        slider5.set_current_digit(math.floor(second / 10))
        slider6.set_current_digit(second % 10)
